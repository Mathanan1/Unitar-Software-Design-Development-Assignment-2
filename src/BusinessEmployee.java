class BusinessEmployee extends Employee {
    ...
    // budget determined will depend on which type of Business_Employee it is.Group project:Surya,Vikki,Mathan
    ...
    // , size of their currentlybudget.Group project:Surya,Vikki,Mathan
