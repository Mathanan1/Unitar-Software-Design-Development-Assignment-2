...
class Employee {
    ...
    // of the user and one for base_salary. Group project:Surya,Vikki,Mathan
    protected Employee(String name, double baseSalary){
        this.name=name;
        int i = ++countID;
        this.basicSalary=baseSalary;
    }
    //return the employee's salary. Group project:Surya,Vikki,Mathan
    protected double getBaseSalary(){
        return this.basicSalary;
    }
    //return the employee's_name. Group project:Surya,Vikki,Mathan
    public String getName(){
        return this.name;
    }
    //return the employee's ID & issued on behalf of the employee at
    // the time they constructed. Employee have ID 1,
    // the second 2 and the third 3 so on. Group project:Surya,Vikki,Mathan
    protected int getEmployeeID(){

        return this.employeeID;
    }
    //Should_return a reference to Employee object
    // that represents this manager of employees.Group project:Surya,Vikki,Mathan
    ...
    // false otherwise Group project:Surya,Vikki,Mathan
    ...
    // followed by the employee name.Group project:Surya,Vikki,Mathan
    ...
    // This will be different for every subclass of Employee Group project:Surya,Vikki,Mathan
